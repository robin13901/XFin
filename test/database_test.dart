...
void main() {
  ...
  //     );
  //     await database.bookingsDao.createBookingAndUpdateAccount(booking);
  //
  //     // ASSERT
  ...
  //
  //     // ACT
  //     await database.bookingsDao.deleteBookingAndUpdateAccount(bookingId);
  //
  //     // ASSERT
  //     final account = await getAccount(accountId);
  //     expect(account.balance, 100.0);
  ...
  //     await database.bookingsDao.updateBookingAndUpdateAccount(bookingToUpdate, updatedCompanion);
  //
  //     // ASSERT
  //     final account = await getAccount(accountId);
  ...
  //     await database.bookingsDao.createBookingAndUpdateAccount(BookingsCompanion(
  //       amount: const Value(25.0),
  //       date: Value(getTodayAsInt()),
  //       sendingAccountId: Value(sendingId),
  //       receivingAccountId: Value(receivingId),
  ...
  //     );
  //     await database.bookingsDao.createBookingAndUpdateAccount(existingBooking);
  //
  //     // ACT
  ...
  //
  //     // ACT
  //     final stream = database.bookingsDao.watchBookingsWithAccount();
  //
  //     // ASSERT
  //     expect(stream, emits(
