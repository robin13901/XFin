...
class $TradesTable extends Trades with TableInfo<$TradesTable, Trade> {
  ...
  static const VerificationMeta _movedValueMeta = const VerificationMeta(
    'movedValue',
  );
  @override
  ...
  static const VerificationMeta _profitAndLossMeta = const VerificationMeta(
    'profitAndLoss',
  );
  @override
  ...
  static const VerificationMeta _tradingFeeMeta = const VerificationMeta(
    'tradingFee',
  );
  @override
  ...
  static const VerificationMeta _clearingAccountIdMeta = const VerificationMeta(
    'clearingAccountId',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('moved_value')) {
      context.handle(
        _movedValueMeta,
        movedValue.isAcceptableOrUnknown(data['moved_value']!, _movedValueMeta),
      );
    } else if (isInserting) {
    ...
    if (data.containsKey('trading_fee')) {
      context.handle(
        _tradingFeeMeta,
        tradingFee.isAcceptableOrUnknown(data['trading_fee']!, _tradingFeeMeta),
      );
    } else if (isInserting) {
  ...
  Trade map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Trade(
      ...
      type: $TradesTable.$convertertype.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}type'],
        )!,
      ),
      movedValue: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}moved_value'],
      )!,
      ...
      profitAndLoss: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}profit_and_loss'],
      )!,
      tradingFee: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}trading_fee'],
      )!,
      clearingAccountId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}clearing_account_id'],
      )!,
      portfolioAccountId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}portfolio_account_id'],
      )!,
    );
  }
...
class Trade extends DataClass implements Insertable<Trade> {
  ...
  Trade copyWithCompanion(TradesCompanion data) {
    return Trade(
      ...
      type: data.type.present ? data.type.value : this.type,
      movedValue: data.movedValue.present
          ? data.movedValue.value
          : this.movedValue,
      ...
      profitAndLoss: data.profitAndLoss.present
          ...
          : this.profitAndLoss,
      tradingFee: data.tradingFee.present
          ? data.tradingFee.value
          : this.tradingFee,
...
class TradesCompanion extends UpdateCompanion<Trade> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (type.present) {
      map['type'] = Variable<String>(
        $TradesTable.$convertertype.toSql(type.value),
      );
    }
...
class $PeriodicBookingsTable extends PeriodicBookings
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<PeriodicBooking> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  PeriodicBooking map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PeriodicBooking(
      ...
      cycle: $PeriodicBookingsTable.$convertercycle.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
...
class PeriodicBooking extends DataClass implements Insertable<PeriodicBooking> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    }
    {
      map['cycle'] = Variable<String>(
        $PeriodicBookingsTable.$convertercycle.toSql(cycle),
      );
    }
    return map;
  }
  ...
  factory PeriodicBooking.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class $PeriodicTransfersTable extends PeriodicTransfers
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<PeriodicTransfer> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  PeriodicTransfer map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PeriodicTransfer(
      ...
      cycle: $PeriodicTransfersTable.$convertercycle.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}cycle'],
        )!,
...
class PeriodicTransfer extends DataClass
  ...
  factory PeriodicTransfer.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class $AssetsOnAccountsTable extends AssetsOnAccounts
  ...
  static const VerificationMeta _sharesOwnedMeta = const VerificationMeta(
    'sharesOwned',
  );
  @override
  ...
  static const VerificationMeta _netBuyInMeta = const VerificationMeta(
    'netBuyIn',
  );
  @override
  ...
  static const VerificationMeta _brokerBuyInMeta = const VerificationMeta(
    'brokerBuyIn',
  );
  @override
  ...
  static const VerificationMeta _buyFeeTotalMeta = const VerificationMeta(
    'buyFeeTotal',
  );
  @override
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<AssetOnAccount> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  AssetOnAccount map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AssetOnAccount(
      ...
      sharesOwned: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}shares_owned'],
      )!,
      netBuyIn: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}net_buy_in'],
      )!,
      brokerBuyIn: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}broker_buy_in'],
      )!,
      buyFeeTotal: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}buy_fee_total'],
      )!,
    );
  }
...
class AssetOnAccount extends DataClass implements Insertable<AssetOnAccount> {
  ...
  factory AssetOnAccount.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AssetOnAccount copyWithCompanion(AssetsOnAccountsCompanion data) {
    return AssetOnAccount(
      ...
      sharesOwned: data.sharesOwned.present
          ? data.sharesOwned.value
          : this.sharesOwned,
      netBuyIn: data.netBuyIn.present ? data.netBuyIn.value : this.netBuyIn,
      brokerBuyIn: data.brokerBuyIn.present
          ? data.brokerBuyIn.value
          : this.brokerBuyIn,
      buyFeeTotal: data.buyFeeTotal.present
          ? data.buyFeeTotal.value
          : this.buyFeeTotal,
    );
  }
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $PeriodicBookingsTable periodicBookings = $PeriodicBookingsTable(
    this,
  );
  late final $PeriodicTransfersTable periodicTransfers =
      $PeriodicTransfersTable(this);
  late final $AssetsOnAccountsTable assetsOnAccounts = $AssetsOnAccountsTable(
    this,
  );
  late final $GoalsTable goals = $GoalsTable(this);
  late final Index bookingsAccountIdDate = Index(
    'bookings_account_id_date',
  ...
  late final Index bookingsComplexQuery = Index(
    'bookings_complex_query',
  ...
  late final Index transfersComplexQuery = Index(
    'transfers_complex_query',
    'CREATE INDEX transfers_complex_query ON transfers (date, receiving_account_id, amount, is_generated)',
  );
  late final Index tradesAssetIdDate = Index(
    'trades_asset_id_date',
  ...
  late final Index goalsAccountId = Index(
    'goals_account_id',
    'CREATE INDEX goals_account_id ON goals (account_id)',
  );
  late final Index goalsTargetDate = Index(
    'goals_target_date',
  ...
  late final AssetsOnAccountsDao assetsOnAccountsDao = AssetsOnAccountsDao(
    this as AppDatabase,
  );
  ...
  late final PeriodicBookingsDao periodicBookingsDao = PeriodicBookingsDao(
    this as AppDatabase,
  );
  late final PeriodicTransfersDao periodicTransfersDao = PeriodicTransfersDao(
    this as AppDatabase,
  );
...
final class $$AccountsTableReferences
  ...
  static MultiTypedResultKey<$BookingsTable, List<Booking>> _bookingsRefsTable(
    ...
    db.bookings,
    aliasName: $_aliasNameGenerator(db.accounts.id, db.bookings.accountId),
  );
  ...
  _periodicBookingsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.periodicBookings,
    aliasName: $_aliasNameGenerator(
      db.accounts.id,
      db.periodicBookings.accountId,
    ),
  );

  $$PeriodicBookingsTableProcessedTableManager get periodicBookingsRefs {
    final manager = $$PeriodicBookingsTableTableManager(
      $_db,
      $_db.periodicBookings,
    ).filter((f) => f.accountId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _periodicBookingsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  ...
  _assetsOnAccountsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.assetsOnAccounts,
    aliasName: $_aliasNameGenerator(
      db.accounts.id,
      db.assetsOnAccounts.accountId,
    ),
  );

  $$AssetsOnAccountsTableProcessedTableManager get assetsOnAccountsRefs {
    final manager = $$AssetsOnAccountsTableTableManager(
      $_db,
      $_db.assetsOnAccounts,
    ).filter((f) => f.accountId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _assetsOnAccountsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
final class $$AssetsTableReferences
  ...
  _assetsOnAccountsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.assetsOnAccounts,
    aliasName: $_aliasNameGenerator(db.assets.id, db.assetsOnAccounts.assetId),
  );
...
final class $$TransfersTableReferences
  ...
  static $AccountsTable _receivingAccountIdTable(_$AppDatabase db) =>
      db.accounts.createAlias(
        $_aliasNameGenerator(db.transfers.receivingAccountId, db.accounts.id),
      );
...
final class $$TradesTableReferences
  ...
  static $AssetsTable _assetIdTable(_$AppDatabase db) => db.assets.createAlias(
    $_aliasNameGenerator(db.trades.assetId, db.assets.id),
  );
...
class $$TradesTableTableManager
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            bool assetId,
            bool clearingAccountId,
            bool portfolioAccountId,
          })
        > {
...
final class $$PeriodicBookingsTableReferences
    extends
        BaseReferences<_$AppDatabase, $PeriodicBookingsTable, PeriodicBooking> {
...
class $$PeriodicBookingsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
...
typedef $$PeriodicBookingsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $PeriodicBookingsTable,
      PeriodicBooking,
...
final class $$PeriodicTransfersTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
  ...
  static $AccountsTable _sendingAccountIdTable(_$AppDatabase db) =>
      db.accounts.createAlias(
        $_aliasNameGenerator(
          db.periodicTransfers.sendingAccountId,
          db.accounts.id,
        ),
      );
  ...
  static $AccountsTable _receivingAccountIdTable(_$AppDatabase db) =>
      db.accounts.createAlias(
        $_aliasNameGenerator(
          db.periodicTransfers.receivingAccountId,
          db.accounts.id,
        ),
      );
...
class $$PeriodicTransfersTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $PeriodicTransfersTable,
...
typedef $$PeriodicTransfersTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $PeriodicTransfersTable,
      PeriodicTransfer,
...
final class $$AssetsOnAccountsTableReferences
    extends
        BaseReferences<_$AppDatabase, $AssetsOnAccountsTable, AssetOnAccount> {
...
class $$AssetsOnAccountsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
...
typedef $$AssetsOnAccountsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $AssetsOnAccountsTable,
      AssetOnAccount,
